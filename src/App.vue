<template>
  ...
  <div v-if="isLoginPage" class="min-h-screen bg-[#0b0f19] font-sans text-slate-100 antialiased flex items-center justify-center relative">
    <router-view />
  </div>

  <!-- Authenticated Application Layout -->
  <div v-else class="flex h-screen bg-[#0b0f19] font-sans text-slate-100 antialiased overflow-hidden p-3 md:p-4 gap-3 md:gap-4 relative">
    <!-- Sidebar Navigation -->
    <Sidebar />
